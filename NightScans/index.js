...
var source = (() => {
  ...
  // src/MangaStreamSettingsForm.ts
  init_buffer();
  ...
  var MangaStreamGeneric = class {
    ...
    async getChapters(sourceManga, _) {
      const request = {
    ...
    async getDiscoverSectionItems(section, metadata) {
      ...
      return { items: await this.parser.parseHomeSection($2, s, this), metadata };
    }
  ...
  var NightScansExt = class extends MangaStreamGeneric {
    ...
    configureSections() {
      ...
      this.latestUpdatesSection.subtitleSelectorFunc = ($2, element) => $2("a.maincl", element).first().text().trim();
    }
  };
